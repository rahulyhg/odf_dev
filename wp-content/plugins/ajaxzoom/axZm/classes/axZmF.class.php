...
if (!class_exists('axZmF', false)) {
    class axZmF
    {
        ...
        public static function batchAjaxSwitchBatch($zoom, $batch = '', $pic_list_array, $pic_list_data)
        {
            $retScript = '';
            $a = explode('_', $batch);
        ...
        public static function batchAjaxSwitchDir($zoom, $dir = '', $pic_list_array, $pic_list_data)
        {
        ...
        public static function batchAjaxDeleteCacheFor($zoom, $picName, $pic_list_array, $pic_list_data)
        {
        ...
        public static function getNumberImagesInFolders($zoom, $pic_list_array, $depth, $withPaths = 0, $needToProcess = 0)
        {
            $startTime = microtime(true);
            $numImages = 0;
            $imgNames = array();
        ...
        public static function batchAjaxProcessBatchFile($zoom, $zoomID, $pic_list_array, $pic_list_data)
        {
