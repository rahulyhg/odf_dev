...
<div class="clearfix model1" style="background-image: url(<?php echo the_post_thumbnail_url('portfolio-square');?>); background-position-y:center; background-size: 50%; background-color: #ffffff;">
