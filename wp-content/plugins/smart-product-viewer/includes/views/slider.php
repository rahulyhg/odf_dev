...
(function($) {
	...
	var product_<?php $this->ID(); ?> = $('#threesixty-slider-<?php $this->ID(); ?>').ThreeSixty({
		...
		monitorInt: <?php echo $this->monitorInt; ?>,
		...
		onReady: function() {
			...
			$('#nouislider-<?php $this->ID(); ?>').noUiSlider({
				...
				start: <?php echo $this->scrollbar_start; ?>,
				step: 1,
				orientation: '<?php echo ($this->verticalScrollbar()) ? "vertical" : "horizontal"; ?>',
			...
			$('#nouislider-<?php $this->ID(); ?>.noUi-vertical').height(parseInt($('#threesixty-slider-<?php $this->ID(); ?>').height())-40);
			<?php endif; ?>
		}
	...
	<?php elseif ( $this->stopOnHover == 'true' ) : ?>
	$("#threesixty-slider-<?php $this->ID(); ?>").mouseover(function(){
		product_<?php $this->ID(); ?>.stop();
	});
	$("#threesixty-slider-<?php $this->ID(); ?>").mouseleave(function(){
