...
<div class="clearfix model2" style="background-image: url(<?php echo the_post_thumbnail_url('latest_post_boxes');?>); background-position-x:center; background-size: 100%; background-color: #ffffff;">
