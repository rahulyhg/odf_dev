...
$axZmBatchConfig = array('ver' => '2.3', 'date' => '2018-08-30');
...
if ((isset($_GET['zoomID']) && !empty($_SESSION['axZmBtch']['batchJob'])) 
    ...
    if (isset($_GET['zoomID'])
        ...
        echo axZmF::batchAjaxProcessBatchFile($zoom, (int)$_GET['zoomID'], $pic_list_array, $pic_list_data);
    }
        ...
        $batchHtml .= '<div class="mainInnerFrame row">';
            ...
            $batchHtml .= '<div class="leftFrameParent col-xs-6">';
                $batchHtml .= '<div class="panel panel-default">';
                    ...
                    $batchHtml .= '<div class="panel-footer clearfix" id="leftFrameFoot" style="padding: 10px">';
